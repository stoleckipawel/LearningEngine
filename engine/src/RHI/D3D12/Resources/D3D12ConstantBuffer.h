...
template <typename T> class D3D12ConstantBuffer
{
  public:
	...
	{
		return Resource != nullptr && m_MappedData != nullptr;
	}
  ...
  private:
	...
	void CreateResource()
	{
		...
		CHECK(GD3D12Rhi.GetDevice()->CreateCommittedResource(&heapProperties,
