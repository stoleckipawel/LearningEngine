...
void D3D12RootSignature::Create()
{
	...
	rootParameters[RootBindings::RootParam::TextureSRV].InitAsDescriptorTable(1, &ranges[0], RootBindings::Visibility::TextureSRV);

	rootParameters[RootBindings::RootParam::Sampler].InitAsDescriptorTable(1, &ranges[1], RootBindings::Visibility::Sampler);
